...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'photo_profile' => 'required|mimes:jpg|max:1024',
        ...
        $student->save();
        return redirect('/list-siswa')->with('success', 'activity has added!');
    }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            'name.required' => 'kudu di isi jang nama na',
            'classes.required' => 'isi class na ',
            'major.required' => 'jurusan na naon jang',
        ]);
        $student = new ListStudent;
        $data = $student->find($id);
        ...
        return redirect('/list-siswa')->with('success', 'update has added!');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/list-siswa')->with('success', 'activity has delete');
    }
}
